...
describe('resolvePathAlias', () => {
  ...
  test('imports with baseUrl . (without paths option)', () => {
    const imports = [
      'src/TestFile1',
      'src/TestFile2',
      'src/test/TestFile3',
      ...
      'src/TestFile1.ts',
      'src/TestFile2.ts',
      'src/test/TestFile3.ts',
      'src/test/TestFile4.ts',
    ];
    const currentFileAbsoluteDir = 'C:/dir/testProject/src';
    const baseUrl = '.';
    const paths = {};
  ...
  test('imports with baseUrl src (without paths option)', () => {
    const imports = [
      'TestFile1',
      'TestFile2',
      'test/TestFile3',
  ...
  test('imports with baseUrl src and paths option', () => {
    const imports = [
      '@/TestFile1',
      '@/TestFile2',
      '@/test/TestFile3',
  ...
  test('imports with baseUrl . and paths option', () => {
    ...
    const expectedResults = [
      'C:/dir/testProject/TestFile1',
      'C:/dir/testProject/TestFile2',
      'C:/dir/testProject/test/TestFile3',
      'C:/dir/testProject/test/TestFile4',
      'C:/dir/testProject/TestFile1.ts',
      'C:/dir/testProject/TestFile2.ts',
      'C:/dir/testProject/test/TestFile3.ts',
      'C:/dir/testProject/test/TestFile4.ts',
      'C:/dir/testProject/component/TestFile5',
      'C:/dir/testProject/component/TestFile5.tsx',
    ];

    expect(resolvePathAlias(imports, currentFileAbsoluteDir, baseUrl, paths)).toStrictEqual(expectedResults);
  });

  test('relative imports with baseUrl . and paths option', () => {
    const imports = [
      './TestFile1',
      '../TestFile2',
      './test/TestFile3',
